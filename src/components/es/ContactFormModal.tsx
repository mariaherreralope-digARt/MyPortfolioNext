          ...
          >
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                ...
                className="text-gray-700 dark:text-gray-100 hover:opacity-80 transition"
              >
            ...
            >
              ...
              <input
                type="hidden"
                name="_autoresponse"
                value="Gracias por tu mensaje. En breve recibiras respuesta"
              />
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full px-4 py-2 text-white bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 rounded-3xl shadow-sm hover:shadow-yellow-400"
              >
                Enviar Mensaje
              </motion.button>
            </form>
