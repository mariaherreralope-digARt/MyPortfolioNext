...
const testimonials = [
  ...
  {
    id: 3,
    name: "So – Sofia M., organizadora de eventos",
...
Testimonios de Clientes        </motion.h2>
        <motion.p className="text-slate-100">
          Unas palabras de clientes que confiaron en mí para poner convertir sus ideas en realidad.
        </motion.p>
      </motion.div>
        ...
        >
          {testimonials.map((testimonial) => (
            <SwiperSlide key={testimonial.id} className="h-full md:py-12 py-4">
              ...
              >
                <motion.div className="w-24 h-24 mx-auto mt-4 mb-4 relative">
                  <Image
                ...
                <motion.p className="text-slate-100">{testimonial.text}</motion.p>
              </motion.div>
            </SwiperSlide>
          ))}
        </Swiper>
